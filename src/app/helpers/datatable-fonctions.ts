  ...
  if (isClient) {
    ...
    if (args.valid)
      $(`td:eq(${args.column})`, nRow).append(
        `<button
      class="ml-2 mr-2 btn-icon btn-transition btn btn-outline-primary collapsed actions-button"
      aria-expanded="false"
      ...
      <button
      class="ml-2 mr-2 btn-icon btn-transition btn btn-outline-focus collapsed actions-button"
      aria-expanded="false"
    ...
    if (args.valid || args.reject)
      ...
      <button
        class="ml-2 mr-2 btn-icon btn-transition btn btn-outline-success collapsed actions-button"
        aria-expanded="false"
      ...
      <button
        class="ml-2 mr-2 btn-icon btn-transition btn btn-outline-danger collapsed actions-button"
        aria-expanded="false"
