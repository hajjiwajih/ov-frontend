export const environment = {
  ...
  // api routes
  api_url: "http://ov-backend.test.svc:3500/api",
  api_url_users: "http://ov-backend.test.svc:3500/api/users",
  ...
  // socket server
  socketIO_endpoint: "http://ov-front-voucher.192.168.0.142.nip.io",
